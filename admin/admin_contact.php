...
if(isset($_POST['submit'])){
	...
	$query = "SELECT * FROM Hostel_Manager WHERE Username = '$admin_uname'";
	...
	$query = "INSERT INTO Message (sender_id,receiver_id,hostel_id,subject_h,message,msg_date,msg_time) VALUES ('$admin_id','$hos_man_user','$hostel_id','$subject','$message','$today_date','$time')";
    $result = mysqli_query($conn,$query);
    if($result){
