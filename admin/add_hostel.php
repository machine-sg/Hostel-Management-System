...
<body style="font-family: 'Times New Roman', serif;">
	...
	<section class="contact py-5">
		<div class="container">
			<h2 class="heading text-capitalize mb-sm-5 mb-4"> Add Hostel </h2>
						...
						<div class="row">
							...
							<div class="col-md-5 contact_left_grid" data-aos="fade-right">
								...
								<div class="contact-fields-w3ls">
									...
									<input type="text" name="hostel_name" placeholder="Hostel" required="">
								</div>
								<div class="contact-fields-w3ls">
									
									<input type="text" name="no_of_rooms" placeholder="Number of Rooms" required="">
								</div>
								<div class="contact-fields-w3ls">
									
									<input type="text" name="year" placeholder="For Which Year Students" required="">
								</div>
								<div class="contact-fields-w3ls">
...
if(isset($_POST['add'])){
    ...
    $query1 = "SELECT * FROM Hostel where Hostel_name = '$hostel_name'";
    $result1 = mysqli_query($conn,$query1);
    if(mysqli_num_rows($result1)==0){
		
        $query2 = "INSERT INTO Hostel(Hostel_name, No_of_rooms, Year, Gender) VALUES('$hostel_name','$no_of_rooms', '$year', '$gender')";
        $result = mysqli_query($conn,$query2);
        if($result){
            echo "<script type='text/javascript'>alert('Successflly added the Hostel!')</script>";
        }
        else{
            echo "<script type='text/javascript'>alert('Error in adding hostel!!! Please try again.')</script>";
        }
        
    }
    else{
        echo "<script type='text/javascript'>alert('Hostel is present. Add a new hostel')</script> ";
    }
    exit();
}
?>
